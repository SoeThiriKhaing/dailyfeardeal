                      ...
                      if (index == 5) {
                        return GestureDetector(
                          onTap: () {
                            ...
                            Get.snackbar("Success", "Go to Feature Restaurants Page");
                          },
                          child: const Center(
                            child: Icon(Icons.arrow_forward, size: 50, color: Colors.black),
                          ),
                        );
                      }
                      ...
                      return Card(
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              const Icon(Icons.restaurant, size: 50, color: Colors.orangeAccent),
